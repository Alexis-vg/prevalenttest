  ...
  theme: {
    extend: {
      ...
      backgroundImage: (theme) => ({
        ...
        "spyglass-white-icon": "url('assets/icons/spyglass.svg')",
        "gear-white-icon": "url('assets/icons/gear-white.svg')",
        "building-white-icon": "url('assets/icons/building.svg')",
        "gear-white-icon": "url('assets/icons/gear-white.svg')",
        ...
        "clipper-icon": "url('assets/icons/clipper-icon.svg')",
      }),
      gridTemplateColumns: {
        cards: "95px 3fr",
      },
